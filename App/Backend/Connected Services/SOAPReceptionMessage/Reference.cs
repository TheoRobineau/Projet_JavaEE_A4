...
namespace Backend.SOAPReceptionMessage {
    ...
    public interface ReceptionEndpoint {
        ...
        // CODEGEN : La génération du contrat de message depuis le nom d'élément file de l'espace de noms  n'est pas marqué nillable
    ...
    public partial class ReceptionOperationRequestBody {
        ...
        public ReceptionOperationRequestBody(string file, string key, string fileName) {
            this.file = file;
            this.key = key;
    ...
    public partial class ReceptionEndpointClient : System.ServiceModel.ClientBase<Backend.SOAPReceptionMessage.ReceptionEndpoint>, Backend.SOAPReceptionMessage.ReceptionEndpoint {
        ...
        public string ReceptionOperation(string file, string key, string fileName) {
        ...
        public System.Threading.Tasks.Task<Backend.SOAPReceptionMessage.ReceptionOperationResponse> ReceptionOperationAsync(string file, string key, string fileName) {
            Backend.SOAPReceptionMessage.ReceptionOperationRequest inValue = new Backend.SOAPReceptionMessage.ReceptionOperationRequest();
            inValue.Body = new Backend.SOAPReceptionMessage.ReceptionOperationRequestBody();
            inValue.Body.file = file;
            inValue.Body.key = key;
